...
import { AlertPlugin, ToastPlugin, ConfirmPlugin, DatetimePlugin, LoadingPlugin,Toast  } from 'vux'
// 弹出层引入
...
router.beforeEach(function (to, from, next) {
  ...
  const whiteList = ['/Login','/Pregister','/Pforgetpsd'];
  // 判断是否登陆及相关跳转
  //console.log(location.href)
  
  function loginMain(cons){
