                ...
                try {
                    if(this.airforce.configs_post.data){
                        ...
                        this.getCode({
                            ...
                            data:"http://yr.5yaofq.com/index.php?g=WeChat&m=Wechat&a=wxlogin&phone="+this.airforce.prefectInfo.phone+"&id="+this.$route.query.AntPushAll+"&router=ApplicationDetails",
                            //data:$$docWww + "public/#/ApplicationDetails?id="+this.$route.query.AntPushAll+"&phone="+this.airforce.login_post.data.phone,
                        });
                        return findObj;
                    }
                }catch (e){}
                ...
                try {
                    if(this.airforce.configs_post.data &&  this.$route.query.pushQrCodeUrl){
                        this.getCode({
                            ...
                            data:"http://yr.5yaofq.com/index.php?g=WeChat&m=Wechat&a=wxlogin&phone="+this.airforce.prefectInfo.phone+"&type=2&router=AntPushShop",
                            // data:$$docWww + "public/#/ApplicationDetails?type=2&phone="+this.airforce.login_post.data.phone,
                        });
                        return "";
                    }
                }catch (e){}
